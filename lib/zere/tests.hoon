...
++  dec-jet  [[11 [%zfast [1 %$^%dec] 0 6] 7 [10 [2 0 47] 0 1] 6 [5 [0 6] 1 0] [0 0] 7 [[0 95] [1 0] 0 6] 6 [5 [0 7] 4 0 6] [0 6] 9 2 10 [6 4 0 6] 0 1] 0 0]
...
:~   :-  'basic-nock'
     ...
     :~
           '1'^test:mk(s 0, f [1 5])
           '3'^test:mk(s 0, f [3 1 5])
           '3'^test:mk(s 0, f [3 1 5 6])
           '4'^test:mk(s 0, f [4 1 5])
           '5'^test:mk(s 0, f [5 [1 5] [1 6]]) 
           '5'^test:mk(s 0, f [5 [1 5] [1 5]]) 
           '6'^test:mk(s 8, f [6 [1 0] [1 2] 1 3]) 
           '6'^test:mk(s 8, f [6 [1 1] [1 2] 1 3])
           '7'^test:mk(s 4, f [7 [1 3] 0 1])
           '8'^test:mk(s 4, f [8 [1 3] 0 1])
           'cons'^test:mk(s 4, f [[1 3] 1 4])
           '6-cons'^test:mk(s 8, f [[6 [1 0] [1 2] 1 3] 6 [1 1] [1 2] 1 3])
           '2'^test:mk(s 8, f [2 [1 1] [1 1 1]])          
